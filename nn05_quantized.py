...
#load data
X_train = np.load('X_train_quant.npy')
y_train = np.load('y_train_quant.npy')

X_test = np.load('X_test_quant.npy')
y_test = np.load('y_test_quant.npy')

X_val = np.load('X_val_quant.npy')
y_val = np.load('y_val_quant.npy')
